    ...
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="hidden sm:block relative">
                ...
                <input type="text"
                       placeholder="Search..."
                       class="w-56 pl-9 pr-4 py-2 rounded-lg border border-gray-200 bg-gray-50/50 text-sm text-charcoal placeholder:text-cool-gray focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-200"
                />
            </div>
            ...
            {{-- Notifications --}}
            <button class="relative p-2 rounded-lg text-cool-gray hover:bg-gray-100 hover:text-charcoal transition-colors duration-200">
